    ...
    <section style={{ padding: '100px 24px', background: 'linear-gradient(180deg, #04045E 0%, #060670 100%)', position: 'relative', overflow: 'hidden' }}>
      <motion.div
        ...
        style={{
          ...
          margin: '0 auto',
          textAlign: 'center',
          background: 'linear-gradient(135deg, rgba(185,250,60,0.1), rgba(185,250,60,0.03))',
      ...
      >
        ...
        >
          ...
          <span style={{ color: '#B9FA3C', fontSize: 13, fontWeight: 600 }}>30-day free trial available</span>
        </motion.div>

        <h2 style={{ fontSize: 'clamp(32px, 4vw, 52px)', fontWeight: 900, color: '#fff', lineHeight: 1.1, marginBottom: 20, letterSpacing: '-0.5px' }}>
          Biznesinizə şəffaflıq gətirməyə{' '}
        ...
        <p style={{ fontSize: 18, color: 'rgba(255,255,255,0.65)', lineHeight: 1.7, marginBottom: 40, maxWidth: 500, margin: '0 auto 40px' }}>
          Minlərlə biznes sahibi artıq Invorent ilə investorlarına real-time şəffaflıq təqdim edir.
        </p>

        <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
          <button className="btn-primary" style={{ fontSize: 16, padding: '16px 36px' }}>
            <Calendar size={20} /> Demo İstəyin <ArrowRight size={18} />
          </button>
        ...
        <p style={{ color: 'rgba(255,255,255,0.35)', fontSize: 13, marginTop: 24 }}>
          Kredit kartı tələb edilmir · Quraşdırma 30 dəqiqə
        </p>
      </motion.div>
    </section>
  );
